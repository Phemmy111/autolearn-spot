              ...
              >
                {isOpen && (
                  <>
                    ...
                    <button
                      aria-label="Close"
                      className="absolute -right-3 -top-3 z-[110] flex h-8 w-8 items-center justify-center rounded-full border border-[#10b981]/50 bg-brand-bg text-[#10b981] transition hover:border-[#10b981] hover:bg-brand-bg hover:text-black sm:-right-4 sm:-top-4 sm:h-10 sm:w-10"
                      onClick={handleClose}
                      type="button"
                    >
                      <X className="h-4 w-4" />
                ...
                <div className={isOpen ? 'relative aspect-video w-full bg-brand-bg' : ''}>
                  ...
                  {isOpen && isLocked && (
                    <div className="absolute inset-0 z-50 flex flex-col items-center justify-center bg-brand-bg/90 backdrop-blur-md animate-in fade-in duration-500">
                      <Lock className="mb-4 h-12 w-12 text-[#10b981] opacity-80" />
                      <h3
                        id={modalTitleId}
                        className="mb-2 font-heading text-2xl font-bold uppercase text-brand-text"
                      >
                        Preview Complete
                      </h3>
                      <p className="mb-6 font-mono text-sm text-brand-text/60 max-w-md text-center leading-relaxed">
                        You&apos;ve reached the end of the preview. Enroll now to unlock the full
                        course, live deployments, and get certified.
                      </p>
                      <EnrollModal className="corner-accent relative inline-flex h-12 w-full max-w-xs items-center justify-center border border-[#10b981] bg-brand-bg px-8 font-mono text-xs font-bold uppercase tracking-[0.1em] text-[#00363a] shadow-[0_14px_34px_rgba(0,240,255,0.18)] transition hover:bg-brand-bg">
