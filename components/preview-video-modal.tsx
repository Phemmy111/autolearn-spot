              ...
              >
                {isOpen && (
                  <>
                    ...
                    <button
                      aria-label="Close"
                      className="absolute -right-3 -top-3 z-[110] flex h-8 w-8 items-center justify-center rounded-full border border-[#10b981]/50 bg-[#c0c4c9] text-[#10b981] transition hover:border-[#10b981] hover:bg-[#10b981] hover:text-black sm:-right-4 sm:-top-4 sm:h-10 sm:w-10"
                      onClick={handleClose}
                      type="button"
                    >
                      <X className="h-4 w-4" />
                ...
                <div className={isOpen ? 'relative aspect-video w-full bg-[#c0c4c9]' : ''}>
                  ...
                  {isOpen && isLocked && (
                    <div className="absolute inset-0 z-50 flex flex-col items-center justify-center bg-[#050505]/90 backdrop-blur-md animate-in fade-in duration-500">
                      ...
                      <h3
                        id={modalTitleId}
                        className="mb-2 font-heading text-2xl font-bold uppercase text-neutral-900"
                      >
                        Preview Complete
                      </h3>
                      ...
                      <EnrollModal className="corner-accent relative inline-flex h-12 w-full max-w-xs items-center justify-center border border-[#10b981] bg-[#10b981] px-8 font-mono text-xs font-bold uppercase tracking-[0.1em] text-[#00363a] shadow-[0_14px_34px_rgba(0,240,255,0.18)] transition hover:bg-[#dbfcff]">
