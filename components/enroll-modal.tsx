      ...
      {isOpen && isMounted
        ? createPortal(
            <div
              ...
              aria-modal="true"
              className="fixed inset-0 z-[300] flex items-center justify-center overflow-y-auto bg-brand-bg/82 px-3 py-4 backdrop-blur-md sm:px-6 sm:py-8"
              role="dialog"
            >
              <button
              ...
              <div className="relative max-h-[calc(100vh-2rem)] w-full max-w-[520px] overflow-y-auto border border-[#3b494b] bg-brand-bg p-4 text-[#e2e2e8] shadow-[0_30px_100px_rgba(0,0,0,0.55)] sm:p-6">
                ...
                <div className="relative mb-5 border border-brand-border bg-brand-bg/92 p-5 pr-14 sm:p-6 sm:pr-16">
                  <span className="inline-flex border border-[#10b981]/60 bg-brand-bg/10 px-3 py-1 font-mono text-[10px] font-semibold uppercase tracking-[0.14em] text-[#10b981]">
                    Step 1 of 2
                  </span>
                  <h2
                ...
                <form className="relative space-y-4" onSubmit={onSubmit}>
                  ...
                  <div className="flex items-center justify-between border border-brand-border bg-brand-bg px-4 py-4">
                    <div>
                  ...
                  <button
                    className="corner-accent blueprint-cta flex h-14 w-full items-center justify-center border border-[#10b981] bg-brand-bg px-5 font-mono text-xs font-bold uppercase tracking-[0.1em] text-[#00363a] shadow-[0_14px_34px_rgba(0,240,255,0.18)] transition hover:bg-brand-bg disabled:cursor-wait disabled:opacity-75"
