        ...
        ? createPortal(
            ...
            >
              ...
              <div className="relative max-h-[calc(100vh-2rem)] w-full max-w-[520px] overflow-y-auto border border-[#3b494b] bg-[#050505] p-4 text-[#e2e2e8] shadow-[0_30px_100px_rgba(0,0,0,0.55)] sm:p-6">
                ...
                <div className="relative mb-5 border border-neutral-200 bg-[#c0c4c9]/92 p-5 pr-14 sm:p-6 sm:pr-16">
                  <span className="inline-flex border border-[#10b981]/60 bg-[#10b981]/10 px-3 py-1 font-mono text-[10px] font-semibold uppercase tracking-[0.14em] text-[#10b981]">
                    Step 1 of 2
                  </span>
                  <h2
                ...
                <form className="relative space-y-4" onSubmit={onSubmit}>
                  <label className="block">
                    ...
                    <input
                      className="mt-2 h-12 w-full border border-neutral-200 bg-[#c0c4c9] px-4 font-mono text-sm text-[#e2e2e8] outline-none transition placeholder:text-[#5d5f63] focus:border-[#10b981] focus:bg-[#10151b]"
                      name="name"
                  ...
                  <div className="flex items-center justify-between border border-neutral-200 bg-[#c0c4c9] px-4 py-4">
                    <div>
                  ...
                  <button
                    className="corner-accent blueprint-cta flex h-14 w-full items-center justify-center border border-[#10b981] bg-[#10b981] px-5 font-mono text-xs font-bold uppercase tracking-[0.1em] text-[#00363a] shadow-[0_14px_34px_rgba(0,240,255,0.18)] transition hover:bg-[#dbfcff] disabled:cursor-wait disabled:opacity-75"
