...
export default function QuizSelector({ quizzes, selectedQuizId }: { quizzes: Quiz[]; selectedQuizId?: string }) {
  ...
  return (
    <div className="border border-[var(--border-default)] bg-[var(--card)] rounded-xl p-6 mb-8">
      <div className="flex items-center gap-4">
        <div className="flex-1 max-w-sm">
          ...
          <select
            ...
            className="w-full bg-[var(--surface-hover)] border border-[var(--border-default)] rounded-lg p-3 text-white font-mono text-sm focus:border-[var(--primary)] outline-none"
            onChange={(e) => {
              if (e.target.value) {
