...
export function EnrollmentRequired() {
  ...
  const features = [
    { title: "AI Automation Lessons", icon: <PlaySquare className="h-5 w-5 text-[var(--primary)]" /> },
    { title: "Live Saturday Classes", icon: <Calendar className="h-5 w-5 text-[var(--primary)]" /> },
    { title: "Assignments", icon: <PenTool className="h-5 w-5 text-[var(--primary)]" /> },
    { title: "Practical Projects", icon: <Zap className="h-5 w-5 text-[var(--primary)]" /> },
    { title: "Quizzes", icon: <CheckSquare className="h-5 w-5 text-[var(--primary)]" /> },
    { title: "Certificate", icon: <Award className="h-5 w-5 text-[var(--primary)]" /> },
    { title: "Student Dashboard", icon: <LayoutDashboard className="h-5 w-5 text-[var(--primary)]" /> },
  ];
  ...
  return (
    <div className="flex min-h-screen flex-col items-center p-4 sm:p-6 lg:p-10 bg-[var(--surface-hover)]/80">
      {/* Hero Section */}
      <div className="w-full max-w-5xl text-center mb-10 mt-6">
        ...
        <p className="font-mono text-lg text-[var(--primary)] mb-2">
      ...
      <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="group relative overflow-hidden rounded-xl border border-[var(--border-input)] bg-[var(--surface-hover)] backdrop-blur-sm p-6 sm:p-8 transition-all hover:border-[var(--primary)]/50 hover:shadow-[0_0_30px_rgba(0,240,255,0.1)]">
            ...
            <div className="relative z-10">
              ...
              <div className="mb-8">
                <h3 className="font-mono text-xs uppercase tracking-widest text-[var(--primary)] mb-4">Unlock:</h3>
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3 font-mono text-sm text-[#e2e8e2]">
                  <li className="flex items-center gap-2"><span className="text-[var(--primary)]">✅</span> Complete Video Curriculum</li>
                  <li className="flex items-center gap-2"><span className="text-[var(--primary)]">✅</span> Saturday Live Classes</li>
                  <li className="flex items-center gap-2"><span className="text-[var(--primary)]">✅</span> Weekly Assignments</li>
                  <li className="flex items-center gap-2"><span className="text-[var(--primary)]">✅</span> Practical Quizzes</li>
                  <li className="flex items-center gap-2"><span className="text-[var(--primary)]">✅</span> Certificate of Completion</li>
                  <li className="flex items-center gap-2"><span className="text-[var(--primary)]">✅</span> Student Community</li>
                </ul>
              </div>

              <div className="flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-[var(--border-input)]/50 pt-6">
                <div>
                ...
                <Link
                  ...
                  className="w-full sm:w-auto text-center border border-[var(--primary)] bg-[var(--primary)]/10 px-8 py-4 font-mono text-sm font-bold uppercase text-[var(--primary)] transition-all hover:bg-[var(--primary)] hover:text-black hover:shadow-[0_0_20px_rgba(0,240,255,0.4)] rounded"
                >
                  Pay ₦8,000
                </Link>
              </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="rounded-xl border border-[var(--border-input)] bg-[var(--surface-hover)]/60 backdrop-blur-sm p-6 transition-colors hover:bg-[var(--surface-hover)]">
              ...
              {!showVerifyInput ? (
                <button
                  ...
                  className="flex w-full items-center justify-center gap-2 border border-[var(--border-input)] bg-[var(--surface-hover)] px-4 py-3 font-mono text-xs uppercase text-[#b9cacb] transition-colors hover:border-[var(--primary)] hover:text-[var(--primary)] rounded"
                >
                ...
                <form onSubmit={handleVerify} className="space-y-3">
                  <input
                    ...
                    className="w-full border border-[var(--border-input)] bg-[#0a0c10] px-3 py-2 font-mono text-sm text-white placeholder-[#5d5f63] focus:border-[var(--primary)] focus:outline-none rounded"
                  />
            ...
            <div className="rounded-xl border border-[var(--border-input)] bg-[var(--surface-hover)]/60 backdrop-blur-sm p-6 transition-colors hover:bg-[var(--surface-hover)] flex flex-col">
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-xl border border-[var(--primary)]/30 bg-[var(--surface-hover)]/60 p-6 backdrop-blur-sm relative overflow-hidden transition-all hover:border-[var(--primary)]/50">
            <h3 className="font-mono text-xs uppercase tracking-widest text-[var(--primary)] mb-4 flex items-center gap-2">
            ...
            <div className="mt-4 border-t border-[var(--border-input)]/50 pt-4">
          ...
          <div className="rounded-xl border border-[var(--border-input)] bg-[var(--surface-hover)]/40 p-6 backdrop-blur-sm">
            <h3 className="font-mono text-sm uppercase tracking-widest text-[var(--primary)] mb-6 border-b border-[var(--border-input)] pb-2">
              Feature Preview
            </h3>
            <div className="grid gap-3">
              {features.map((feature, i) => (
                <div key={i} className="flex items-center gap-3 rounded bg-[var(--surface-hover)] p-3 border border-[var(--border-input)]/50">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded bg-[var(--primary)]/10">
                    {feature.icon}
                  </div>
          ...
          <div className="rounded-xl border border-[var(--border-input)] bg-[var(--surface-hover)]/40 p-6 backdrop-blur-sm text-center">
            ...
            <p className="font-mono text-sm text-[var(--primary)] mb-4 truncate">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 border border-[var(--border-input)] bg-[var(--surface-hover)] px-4 py-2 font-mono text-xs uppercase text-[#b9cacb] transition-colors hover:border-red-500 hover:text-red-500 rounded"
            >
      ...
      <div className="w-full max-w-5xl mt-8">
        <div className="rounded-xl border border-[var(--border-input)] bg-[var(--surface-hover)]/60 backdrop-blur-sm p-6 sm:p-8">
          <h3 className="font-heading text-2xl font-bold uppercase text-white mb-6 text-center">Need Help?</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
            <a href="https://wa.me/2348120934828" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center justify-center gap-3 rounded-lg border border-[var(--border-input)]/50 bg-[var(--surface-hover)] p-6 text-center transition-all hover:border-[var(--primary)]/50 hover:bg-[var(--surface-hover)]">
            ...
            <a href="mailto:autolearnspot@gmail.com" className="flex flex-col items-center justify-center gap-3 rounded-lg border border-[var(--border-input)]/50 bg-[var(--surface-hover)] p-6 text-center transition-all hover:border-[var(--primary)]/50 hover:bg-[var(--surface-hover)]">
          ...
          <div className="space-y-4 max-w-3xl mx-auto">
            {faqs.map((faq, index) => (
              <div key={index} className="border border-[var(--border-input)]/50 bg-[var(--surface-hover)] rounded-lg overflow-hidden transition-colors hover:border-[var(--primary)]/50">
                <button
                ...
                >
                  ...
                  <span className="ml-4 flex-shrink-0 text-[var(--primary)]">
                    {openFaqIndex === index ? '−' : '+'}
                  </span>
                </button>
                {openFaqIndex === index && (
                  <div className="border-t border-[var(--border-input)]/30 p-4 text-sm text-[#b9cacb] bg-[#0a0c10]">
                    {faq.answer}
                  </div>
                )}
              </div>
