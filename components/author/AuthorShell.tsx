...
import { Menu, X, Package, Users, DollarSign, BarChart3, Settings, Home, LogOut, Target, FileText, Star, CreditCard, Wallet } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-brand-bg">
      ...
      <div className="hidden md:flex">
        {/* Sidebar */}
        <aside className="w-64 bg-[var(--card)] brightness-95 border-r border-brand-border min-h-screen sticky top-0">
          <div className="p-6">
