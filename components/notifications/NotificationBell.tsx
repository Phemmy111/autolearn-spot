    ...
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        {!isLoadingCount && unreadCount > 0 && (
          <span className="absolute top-1 right-1 flex h-4 w-4 items-center justify-center rounded-full bg-[#10b981] text-[10px] font-bold text-black border-2 border-[#111317]">
