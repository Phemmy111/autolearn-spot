        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
          <div className="w-full max-w-md rounded-xl border border-red-200 bg-white shadow-2xl relative overflow-hidden">
            ...
            <div className="p-6">
              ...
              {error && (
                <div className="mb-4 rounded bg-red-50 p-3 text-sm text-red-600 font-mono flex items-start gap-2 border border-red-200">
              ...
              <div className="flex flex-col gap-3">
                ...
                <button
                  ...
                  disabled={isDeleting}
                  className="flex items-center justify-between p-3 rounded-lg border border-red-200 hover:border-red-300 hover:bg-red-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed group mt-2"
                >
                  <div className="text-left">
