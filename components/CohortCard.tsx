...
export function CohortCard() {
  ...
  return (
    <div className="border border-brand-border bg-brand-bg/80 backdrop-blur-xl rounded-xl p-4 sm:p-5 lg:p-6 animate-scale-in">
      <div className="space-y-3 sm:space-y-4">
        ...
        {formattedDate && (
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-[10px] sm:text-xs text-brand-text/60 uppercase tracking-wider">Starts</p>
        ...
        {/* Duration Badge */}
        <div className="inline-flex items-center gap-2 border border-[#10b981]/40 bg-brand-bg/5 px-3 py-1.5 sm:px-4 sm:py-2 rounded-lg">
