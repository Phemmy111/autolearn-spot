...
export function CohortAnnouncementStrip() {
  ...
  return (
    <div className="relative border-b border-neutral-200 bg-[#c0c4c9]/95 backdrop-blur-xl animate-fade-in">
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 py-2.5 sm:py-3">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-4">
          ...
          <Link
            href="/enroll"
            className="flex items-center gap-1.5 border border-[#10b981]/60 bg-[#10b981]/10 px-3 py-1.5 sm:px-4 sm:py-2 font-mono text-[10px] sm:text-[11px] font-semibold uppercase tracking-[0.1em] text-[#10b981] hover:bg-[#10b981]/20 transition-colors flex-shrink-0"
          >
            Enroll Now
