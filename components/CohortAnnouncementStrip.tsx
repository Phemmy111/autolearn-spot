...
export function CohortAnnouncementStrip() {
  ...
  return (
    <div className="relative border-b border-brand-border bg-brand-bg/95 backdrop-blur-xl animate-fade-in">
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 py-2.5 sm:py-3">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-4">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2">
              ...
              {formattedDate && (
                <>
                  ...
                  <span className="text-[10px] sm:text-[11px] text-brand-text/60">
          ...
          <Link
            href="/enroll"
            className="flex items-center gap-1.5 border border-[#10b981]/60 bg-brand-bg/10 px-3 py-1.5 sm:px-4 sm:py-2 font-mono text-[10px] sm:text-[11px] font-semibold uppercase tracking-[0.1em] text-[#10b981] hover:bg-brand-bg/20 transition-colors flex-shrink-0"
          >
            Enroll Now
