...
export function ProgressBar({ totalVideos }: { totalVideos: number }) {
  ...
  if (isLoading) {
    return (
      <div className="mb-10 border border-neutral-200 bg-gray-50 p-5 animate-pulse">
        <div className="h-4 w-1/3 bg-gray-50 mb-3"></div>
  ...
  return (
    <div className="mb-10 border border-neutral-200 bg-gray-50 p-5">
      ...
      <div className="relative h-2 w-full overflow-hidden bg-gray-50">
        <div
          className="absolute inset-y-0 left-0 bg-gray-50 transition-all duration-700 ease-out"
          style={{ width: `${pct}%` }}
        />
        {/* Glow effect */}
        <div
          className="absolute inset-y-0 left-0 bg-gray-50 blur-sm opacity-50 transition-all duration-700 ease-out"
          style={{ width: `${pct}%` }}
        />
      </div>
    </div>
