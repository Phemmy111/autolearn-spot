  ...
  return (
    <form onSubmit={handleSubmit} className="rounded-2xl bg-[#1a1d23] p-6 shadow-lg space-y-4">
      ...
      <div>
        ...
        <input type="text" required value={bankName} onChange={e => setBankName(e.target.value)} className="mt-1 w-full rounded border border-gray-600 bg-[#c0c4c9] p-2 text-neutral-900" />
      </div>
      <div>
        <label className="block text-sm font-medium text-gray-300">Account Number</label>
        <input type="text" required value={accountNumber} onChange={e => setAccountNumber(e.target.value)} className="mt-1 w-full rounded border border-gray-600 bg-[#c0c4c9] p-2 text-neutral-900" />
      </div>
      <div>
        <label className="block text-sm font-medium text-gray-300">Routing Number</label>
        <input type="text" required value={routingNumber} onChange={e => setRoutingNumber(e.target.value)} className="mt-1 w-full rounded border border-gray-600 bg-[#c0c4c9] p-2 text-neutral-900" />
      </div>
