const fs = require('fs');
const file = 'C:/Users/ACER/Desktop/autolearn-spot/app/author/products/[id]/edit/page.tsx';
...
// Set initialLoad to false after loading
content = content.replace(
  'setLoading(false);',
  setLoading(false);
...
;
content = content.replace('  const handleCategoryChange =', autoSave + '\n  const handleCategoryChange =');

// Update UI
const uiReplace =         {/* ACTIONS */}
...
content = content.replace(/        \{\/\* ACTIONS \*\/\}.*?<\/div>[\s\n]*<\/form>/s, uiReplace + '\n      </form>');
