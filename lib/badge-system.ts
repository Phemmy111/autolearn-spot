...
export { BADGES, Badge, UserBadge }
  ...
  },
  {
    id: 'fast_learner',
    name: '⚡ Fast Learner',
    description: 'Completed the course within 2 weeks',
    icon: '⚡',
  ...
  },
  {
    ...
    description: 'Earned the course certificate',
    icon: '🏆',
    category: 'milestone',
    rarity: 'legendary'
  },
  {
    id: 'quiz_master',
    name: '🧠 Quiz Master',
    description: 'Passed all quizzes with 80%+ average',
    icon: '🧠',
    category: 'performance',
    rarity: 'epic'
  },
  ...
  },
  {
    id: 'early_bird',
    name: '🌅 Early Bird',
    description: 'Completed first week within 3 days',
    icon: '🌅',
    category: 'engagement',
    rarity: 'common'
  },
  {
    ...
    description: 'Maintained 80%+ on-time submission rate',
    icon: '📈',
    category: 'engagement',
    rarity: 'rare'
  }
