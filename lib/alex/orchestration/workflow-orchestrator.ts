...
export class WorkflowOrchestrator {
  ...
  private async handleOrchestrationResult(
    ...
    // CRITICAL FIX: Ensure build exists BEFORE saving plan for plan actions
    ...
    if (action.type === 'plan' && action.plan) {
      ...
      console.log('[FORENSIC] build ensured before plan persistence')
      ...
      console.log('[FORENSIC] Plan action but no plan content:', action.type, !!action.plan)
    }
