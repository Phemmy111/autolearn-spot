        ...
        <div className="flex flex-wrap justify-center gap-2 sm:gap-3 lg:gap-4">
          {trustBadges.map((badge, index) => {
            ...
            return (
              <div
                key={badge.text}
                className={`flex items-center gap-2 border border-brand-border bg-brand-bg/80 backdrop-blur-xl rounded-full px-3 py-1.5 sm:px-4 sm:py-2 lg:px-5 lg:py-2.5 reveal-on-scroll ${isVisible ? 'is-visible' : ''}`}
