    ...
    <main className="flex min-h-screen items-center justify-center bg-[var(--background)] px-4">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <h1 className="mt-2 font-heading text-2xl font-bold uppercase text-[var(--text-primary)]">Sign In</h1>
          <p className="mt-2 font-mono text-sm text-[var(--text-muted)]">Access your AutoLearn Spot curriculum</p>
        </div>
        <SignIn
