    ...
    return (
      <div className="min-h-screen bg-gray-100 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-gray-900 mb-4">Author ID Required</h1>
          <p className="text-gray-600">Please provide an author ID to view their profile.</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gray-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">The author profile you're looking for doesn't exist.</p>
        </div>
      </div>
    );
  }
          ...
          <div className="max-w-4xl mx-auto">
            <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
              ...
              <div className="flex-1 text-center md:text-left">
                <h1 className="text-3xl font-bold text-gray-900 mb-2">{author.display_name}</h1>
                {author.professional_title && (
                  <p className="text-lg text-sky-600 mb-3">{author.professional_title}</p>
                )}
            ...
            {/* Bio */}
            {author.bio && (
              <div className="mt-8 bg-white/50 border border-sky-900/30 rounded-xl p-6">
              ...
              <div className="mt-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {author.expertise.map((expertise) => (
                    <span 
                      key={expertise}
                      className="px-3 py-1 bg-sky-900/30 border border-sky-900/50 rounded-full text-sm text-sky-700"
                    >
                      {expertise}
                    </span>
                  ))}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          {products.length === 0 ? (
            <div className="text-center py-12 bg-white border border-gray-200 rounded-xl">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">No courses published yet</h3>
              <p className="text-gray-600">This author hasn't published any courses yet.</p>
            </div>
          ) : (
