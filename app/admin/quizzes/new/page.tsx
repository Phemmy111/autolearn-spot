    ...
    <div className="min-h-screen bg-brand-bg">
      <div className="container mx-auto px-4 py-12">
        <div className="mb-8">
          ...
          <h1 className="font-heading text-4xl font-bold text-brand-text mb-4">Create New Quiz</h1>
          <p className="font-mono text-sm text-brand-text/70">Set up the basic quiz information</p>
        </div>
