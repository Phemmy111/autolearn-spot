      ...
      <div className="container mx-auto px-4 py-12">
              ...
              <div>
                ...
                <div className="border border-neutral-200 bg-gray-100 rounded-lg overflow-hidden">
                  ...
                  <textarea
                    ...
                    rows={12}
                    className="w-full px-4 py-3 bg-gray-100 text-neutral-900 font-mono text-sm focus:outline-none resize-y"
        ...
        {step === 'review' && generatedQuiz && (
          <div className="max-w-4xl">
            ...
            <div className="border border-neutral-200 bg-gray-100 p-6 rounded-xl mb-6">
