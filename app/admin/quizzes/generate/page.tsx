    ...
    return (
      <div className="min-h-screen bg-brand-bg flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="font-heading text-2xl font-bold text-brand-text mb-2">Generating Quiz...</h2>
          <p className="font-mono text-sm text-brand-text/70">AI is analyzing your lesson script</p>
        </div>
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-brand-bg">
      <div className="container mx-auto px-4 py-12">
        <div className="mb-8">
          ...
          <h1 className="font-heading text-4xl font-bold text-brand-text mb-2">AI Quiz Generator</h1>
          <p className="font-mono text-sm text-brand-text/70">
          ...
          <div className="max-w-3xl">
            ...
            <div className="space-y-6">
              ...
              {providers.length === 0 && (
                <div className="border border-yellow-500/50 bg-yellow-500/10 p-4 rounded-lg flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <Link href="/admin/ai-providers" className="font-mono text-xs text-brand-text/70 hover:text-brand-text">
              ...
              {prompts.length === 0 && (
                <div className="border border-yellow-500/50 bg-yellow-500/10 p-4 rounded-lg flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <Link href="/admin/ai-prompts" className="font-mono text-xs text-brand-text/70 hover:text-brand-text">
              ...
              <div>
                ...
                <div className="border border-brand-border bg-[var(--card)] brightness-95 rounded-lg overflow-hidden">
                  <div className="flex items-center justify-between px-4 py-2 border-b border-brand-border bg-brand-bg">
                    <span className="font-mono text-xs text-brand-text/70">Paste your script or upload a file</span>
                    <label className="flex items-center gap-2 text-[#10b981] hover:text-brand-text font-mono text-xs cursor-pointer">
                  ...
                  <textarea
                    ...
                    rows={12}
                    className="w-full px-4 py-3 bg-[var(--card)] brightness-95 text-brand-text font-mono text-sm focus:outline-none resize-y"
              ...
              <button
                ...
                className="flex items-center gap-2 bg-brand-bg text-black font-bold uppercase tracking-wider font-mono px-6 py-3 rounded hover:bg-[var(--card)] brightness-95 transition-colors disabled:opacity-50"
              >
        ...
        {step === 'review' && generatedQuiz && (
          <div className="max-w-4xl">
            <div className="mb-6 border border-[#10b981]/30 bg-brand-bg/10 p-4 rounded-lg">
              <p className="font-mono text-sm text-[#10b981]">
                Quiz generated successfully! Review the questions below before creating.
              </p>
            </div>

            <div className="border border-brand-border bg-[var(--card)] brightness-95 p-6 rounded-xl mb-6">
              <h2 className="font-heading text-2xl font-bold text-brand-text mb-2">{generatedQuiz.title}</h2>
              <p className="font-mono text-sm text-brand-text/70 mb-4">{generatedQuiz.description}</p>
              <div className="flex gap-4 font-mono text-xs text-brand-text/60">
            ...
            <div className="space-y-4 mb-6">
              {generatedQuiz.questions.map((question, index) => (
                <div
                  key={index}
                  className="border border-brand-border bg-[var(--card)] brightness-95 p-4 rounded-xl"
                >
                  <div className="flex items-start gap-4 mb-3">
                    <span className="px-2 py-1 bg-brand-bg/10 text-[#10b981] font-mono text-xs rounded">
                      Q{index + 1}
                    </span>
                    <div className="flex-1">
                      <p className="font-mono text-sm text-brand-text mb-2">{question.question_text}</p>
                      <div className="flex items-center gap-2 mb-2">
                        <span className="px-2 py-1 bg-brand-bg text-brand-text/70 font-mono text-xs rounded">
