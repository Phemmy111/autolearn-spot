      ...
      try {
        ...
        if (data.application) {
          ...
          setApp({
            ...
            documents: {
              cv: signedUrlsData.cv || appData.cv_url || '#',
              portfolio: signedUrlsData.portfolio || appData.portfolio_samples_url || '#',
              id: signedUrlsData.id || appData.id_document_url || '#' 
            },
