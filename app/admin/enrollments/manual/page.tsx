      ...
      <div className="container mx-auto px-4 py-12 max-w-3xl">
        <div className="mb-8">
          <Link
            ...
            className="flex items-center gap-2 text-brand-text/70 hover:text-brand-text font-mono text-sm mb-4 transition-colors"
          >
          ...
          <div className="flex items-center gap-3">
            ...
            <h1 className="font-heading text-4xl font-bold text-brand-text">Manual Enrollment</h1>
          </div>
          <p className="font-mono text-sm text-brand-text/70 mt-4">
