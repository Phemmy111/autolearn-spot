  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-neutral-50 text-neutral-900 flex items-center justify-center">
        <div className="font-mono text-sm text-neutral-600">Loading submissions...</div>
      </div>
    );
  }
  ...
  return (
    <main className="min-h-screen bg-neutral-50 text-neutral-900">
      ...
      <nav className="sticky top-0 z-50 flex h-16 items-center justify-between border-b border-[#3b494b] bg-neutral-50/95 px-4 backdrop-blur sm:px-6">
        <Link className="flex items-center gap-2 font-mono text-sm font-bold uppercase text-neutral-900" href="/admin/assignments">
              ...
              >
                <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                  <div className="flex-1">
                    ...
                    <div className="mb-4 font-mono text-sm text-neutral-600 space-y-1">
                    ...
                    {submission.screenshot_url && (
                      <div className="mb-4">
                        <p className="font-mono text-xs uppercase text-neutral-600 mb-2">Screenshot:</p>
                        <a
                        ...
                        >
                          ...
                          />
                          <span className="block mt-1 font-mono text-xs text-neutral-600 group-hover:text-[#10b981] transition-colors">Click to open full image ↗</span>
                        </a>
                      </div>
                    )}
                    {submission.notes && (
                      <div className="mb-4 border-t border-[#3b494b] pt-4">
                        <p className="font-mono text-xs uppercase text-neutral-600 mb-2">Student Notes:</p>
                        <p className="font-mono text-sm text-neutral-900">{submission.notes}</p>
                      </div>
                    )}
                    ...
                    {submission.ai_feedback && (
                      <div className="mt-4 border-t border-[#3b494b] pt-4">
                        <p className="font-mono text-xs uppercase text-neutral-600 mb-2">Feedback:</p>
                        <p className="font-mono text-sm text-neutral-900">{submission.ai_feedback}</p>
                      </div>
                    )}
                  </div>
