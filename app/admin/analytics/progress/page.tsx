    ...
    return (
      <div className="container mx-auto py-8 space-y-6">
        <div className="space-y-2">
          <Skeleton className="h-8 w-64 bg-gray-50" />
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-12 max-w-7xl">
        <div className="mb-8">
          ...
          <h1 className="font-heading text-4xl font-bold text-neutral-900 mb-4">Student Progress Analytics</h1>
          <p className="font-mono text-sm text-neutral-600">Comprehensive cohort-wide progress tracking and performance metrics</p>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-4 mb-8">
          <Card className="bg-gray-100 border-neutral-200">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-neutral-900">{analytics.totalStudents}</div>
              <p className="text-xs text-neutral-500">Enrolled in cohort</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gray-100 border-neutral-200">
            ...
            <CardContent>
              ...
              <p className="text-xs text-neutral-500">Course completion</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gray-100 border-neutral-200">
            ...
            <CardContent>
              ...
              <p className="text-xs text-neutral-500">Certificate earned</p>
            </CardContent>
          </Card>
        </div>
        ...
        <Tabs defaultValue="overview" className="space-y-4">
          <TabsList className="bg-gray-100 border-neutral-200">
            ...
            <TabsTrigger value="students" className="data-[state=active]:bg-gray-50">Students</TabsTrigger>
            <TabsTrigger value="performance" className="data-[state=active]:bg-gray-50">Performance</TabsTrigger>
            <TabsTrigger value="at-risk" className="data-[state=active]:bg-gray-50">At-Risk</TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="overview" className="space-y-4">
            <div className="grid gap-6 md:grid-cols-2">
              <Card className="bg-gray-100 border-neutral-200">
                <CardHeader>
                  ...
                  <CardDescription className="text-neutral-600">Student activity and engagement patterns</CardDescription>
                </CardHeader>
              ...
              <Card className="bg-gray-100 border-neutral-200">
                <CardHeader>
                  ...
                  <CardDescription className="text-neutral-600">Score ranges and student performance</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                    ...
                    {analytics.performanceDistribution.scoreRanges.map((range) => (
                      <div key={range.range} className="space-y-2">
                        <div className="flex justify-between text-sm">
                          <span className="text-neutral-600">{range.range}</span>
                          <span className="text-neutral-900 font-medium">{range.count} students ({range.percentage}%)</span>
                        </div>
                  ...
                  <div className="pt-4 border-t border-neutral-200 grid grid-cols-2 gap-4">
                    ...
                    <div>
                      <p className="text-sm text-neutral-500">Median Score</p>
            ...
            <Card className="bg-gray-100 border-neutral-200">
              <CardHeader>
                ...
                <CardDescription className="text-neutral-600">Highest scoring students in the cohort</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                    ...
                    <div key={performer.userId} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                      <div className="flex items-center gap-3">
                        <div className={`w-8 h-8 rounded-full flex items-center justify-center font-bold text-neutral-900 ${
                          index === 0 ? 'bg-yellow-500' : index === 1 ? 'bg-gray-400' : index === 2 ? 'bg-amber-600' : 'bg-gray-50'
                        }`}>
                          {index + 1}
                        </div>
                        <div>
                          <p className="font-medium text-neutral-900">{performer.userName}</p>
          ...
          <TabsContent value="students" className="space-y-4">
            <Card className="bg-gray-100 border-neutral-200">
              <CardHeader>
                ...
                <CardDescription className="text-neutral-600">Sort and filter students by performance metrics</CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  {(['progress', 'score', 'name', 'activity'] as const).map((option) => (
                    <button
                      ...
                      className={`px-4 py-2 text-sm rounded-lg font-medium transition-all ${
                        sortBy === option
                          ? 'bg-gray-50 text-black shadow-lg shadow-[#00f0ff]/20'
                          : 'bg-gray-50 text-neutral-600 hover:bg-neutral-50 border border-[#3b494b]'
                      }`}
                    >
                ...
                <div className="space-y-3">
                  {students.map((student, index) => (
                    <div
                      key={student.userId}
                      className="group flex items-center justify-between p-4 rounded-lg bg-neutral-50 border border-neutral-200 hover:border-[#10b981]/30 transition-all duration-300 hover:shadow-lg hover:shadow-[#00f0ff]/5"
                    >
                      <div className="flex items-center gap-4">
                        <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold text-neutral-900 ${
                          index < 3 ? 'bg-gray-50' : 'bg-gray-50'
                        }`}>
                          {index + 1}
                        </div>
                        <div>
                          <p className="text-sm font-semibold text-neutral-900 group-hover:text-[#10b981] transition-colors">{student.userName}</p>
                      ...
                      <div className="flex items-center gap-6">
                        <div className="text-center">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm font-bold text-neutral-900">{student.progressPercentage}%</span>
                          </div>
                        </div>
                        <div className="text-center">
                        ...
                        <Badge className={`${getStatusColor(student.status)} text-neutral-900`}>
                          {student.status}
                        </Badge>
                      </div>
                    </div>
                    ...
                    <div
                      ...
                      className={`group flex items-center justify-between p-4 rounded-lg border transition-all duration-300 hover:shadow-lg ${
                        index === 0 
                          ...
                          : 'bg-neutral-50 border-neutral-200 hover:border-[#10b981]/30'
                      }`}
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <p className="text-base font-semibold text-neutral-900 group-hover:text-[#10b981] transition-colors">{student.userName}</p>
                          <p className="text-xs text-neutral-500">Top performer</p>
                        </div>
                      </div>
                      <div className="text-right">
              ...
              <CardContent>
                {analytics.performanceDistribution.atRiskStudents.length === 0 ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-sm text-neutral-600">No at-risk students found. All students are on track!</p>
                  </div>
                ) : (
                  <div className="space-y-3">
                    {analytics.performanceDistribution.atRiskStudents.map((student) => (
                      ...
                      >
                        <div className="flex items-center gap-4">
                          <AlertTriangle className="h-5 w-5 text-orange-400" />
                          <div>
                            <p className="text-sm font-semibold text-neutral-900">{student.userName}</p>
                            <p className="text-xs text-neutral-500">Last activity: {new Date(student.lastActivity).toLocaleDateString()}</p>
                          </div>
                        </div>
                        <div className="text-right">
