        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-xl font-bold text-brand-text">Workflow Showcase</h1>
                <p className="text-sm text-brand-text/70">Manage workflow showcase items</p>
              </div>
            </div>
            <button
              onClick={() => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {items.map((item) => (
            <div key={item.id} className="border border-brand-border bg-[var(--card)] brightness-95/50 backdrop-blur-xl rounded-xl p-6">
              ...
              <p className="text-sm text-brand-text/70 mb-4 line-clamp-2">{item.description}</p>
              <div className="flex items-center justify-between">
        ...
        {items.length === 0 && (
          <div className="text-center py-12 text-brand-text/70">
            <Video className="h-12 w-12 mx-auto mb-4 text-brand-text/60" />
          ...
          <div className="bg-[var(--card)] brightness-95 border border-brand-border rounded-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSave} className="p-6 space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  {mediaFile && (
                    <div className="flex items-center justify-between p-2 bg-[var(--card)] brightness-95 border border-brand-border rounded">
                      <span className="text-xs text-brand-text/70 truncate">{mediaFile.name}</span>
                      <button
                        type="button"
                        onClick={() => {
                          setMediaFile(null);
              ...
              {formData.mediaType === 'video' && (
                <>
                  <div>
                    <label className="block text-sm font-medium text-brand-text/70 mb-2">Thumbnail (Optional)</label>
                    <div className="space-y-3">
                      <label className="flex items-center gap-2 px-4 py-3 bg-[var(--card)] brightness-95 border border-brand-border rounded-lg cursor-pointer hover:border-[#10b981] transition-colors">
                        <Upload className="h-4 w-4 text-brand-text/70" />
                        <span className="text-sm text-brand-text/70">
                      ...
                      {thumbnailFile && (
                        <div className="flex items-center justify-between p-2 bg-[var(--card)] brightness-95 border border-brand-border rounded">
                          <span className="text-xs text-brand-text/70 truncate">{thumbnailFile.name}</span>
                          <button
                            type="button"
                            onClick={() => {
                              setThumbnailFile(null);
                  ...
                  <div>
                    <label className="block text-sm font-medium text-brand-text/70 mb-2">Poster (Optional)</label>
                    <div className="space-y-3">
                      <label className="flex items-center gap-2 px-4 py-3 bg-[var(--card)] brightness-95 border border-brand-border rounded-lg cursor-pointer hover:border-[#10b981] transition-colors">
                        <Upload className="h-4 w-4 text-brand-text/70" />
                        <span className="text-sm text-brand-text/70">
                      ...
                      {posterFile && (
                        <div className="flex items-center justify-between p-2 bg-[var(--card)] brightness-95 border border-brand-border rounded">
                          <span className="text-xs text-brand-text/70 truncate">{posterFile.name}</span>
                          <button
                            type="button"
                            onClick={() => {
                              setPosterFile(null);
