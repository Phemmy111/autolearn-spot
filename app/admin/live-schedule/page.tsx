    ...
    <section className="min-h-screen bg-brand-bg">
      <div className="container mx-auto px-4 py-12">
        <div className="mb-8">
          ...
          <h1 className="font-heading text-4xl font-bold text-brand-text mb-4">Live Class Schedule</h1>
          <p className="font-mono text-sm text-brand-text/70">Configure live class schedule settings</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 max-w-md">
            <label className="block">
              ...
              <input
                ...
                className="mt-1 block w-full rounded bg-gray-800 border-gray-700 text-brand-text"
              />
            </label>
            <label className="block">
            ...
            <button type="submit" className="px-4 py-2 bg-indigo-600 text-brand-text rounded hover:bg-indigo-700">
              Save Schedule
            </button>
