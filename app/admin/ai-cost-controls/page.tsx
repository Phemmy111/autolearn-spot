    ...
    return (
      <div className="min-h-screen bg-brand-bg flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="font-mono text-sm text-brand-text/70">Loading cost controls...</p>
        </div>
      </div>
    )
  }
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="font-heading text-4xl font-bold text-brand-text">AI Cost Controls</h1>
              <p className="font-mono text-sm text-brand-text/70">Configure AI usage limits and parameters</p>
            </div>
          </div>
          <button
            onClick={handleSave}
        ...
        <div className="grid gap-6">
          ...
          <div className="border border-brand-border bg-[var(--card)] brightness-95 p-6 rounded-xl">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-heading text-lg font-bold text-brand-text">Enable Cost Controls</h3>
                  <p className="font-mono text-xs text-brand-text/70">Turn cost controls on or off</p>
                </div>
              </div>
          ...
          <div className="border border-brand-border bg-[var(--card)] brightness-95 p-6 rounded-xl">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="font-heading text-lg font-bold text-brand-text">Token Limits</h3>
                <p className="font-mono text-xs text-brand-text/70">Control token usage per request</p>
              </div>
            </div>
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                <label className="block font-mono text-xs text-brand-text/70 mb-2">Max Tokens per Request</label>
                <input
                  type="number"
                  value={controls.max_tokens}
                  onChange={(e) => setControls({ ...controls, max_tokens: parseInt(e.target.value) || 0 })}
                  disabled={!controls.enabled}
                  className="w-full bg-brand-bg border border-[#3b494b] rounded px-4 py-2 text-brand-text font-mono text-sm focus:outline-none focus:border-[#10b981] disabled:opacity-50"
                />
              </div>
              <div>
                <label className="block font-mono text-xs text-brand-text/70 mb-2">Temperature (0-2)</label>
                <input
                  type="number"
                  step="0.1"
                  min="0"
          ...
          <div className="border border-brand-border bg-[var(--card)] brightness-95 p-6 rounded-xl">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="font-heading text-lg font-bold text-brand-text">Request Limits</h3>
                <p className="font-mono text-xs text-brand-text/70">Limit the number of AI requests</p>
              </div>
            </div>
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                <label className="block font-mono text-xs text-brand-text/70 mb-2">Daily Request Limit</label>
                <input
                  type="number"
              ...
              <div>
                <label className="block font-mono text-xs text-brand-text/70 mb-2">Monthly Request Limit</label>
                <input
                  type="number"
          ...
          <div className="border border-brand-border bg-[var(--card)] brightness-95 p-6 rounded-xl">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="font-heading text-lg font-bold text-brand-text">Retry & Timeout Settings</h3>
                <p className="font-mono text-xs text-brand-text/70">Configure retry behavior and timeouts</p>
              </div>
            </div>
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                <label className="block font-mono text-xs text-brand-text/70 mb-2">Max Retries</label>
                <input
                  type="number"
