...
export function ScholarshipClientTable({ initialData, isSuperAdmin }: { initialData: ScholarshipApplication[], isSuperAdmin: boolean }) {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case 'Submitted': return 'text-neutral-600 bg-[#b9cacb]/10 border-[#3b494b]';
      case 'Under Review': return 'text-[#10b981] bg-[#10b981]/10 border-[#10b981]/30';
  ...
  const getPaymentStatusColor = (status: string) => {
    switch (status) {
      case 'Waiting': return 'text-neutral-600 bg-[#b9cacb]/10 border-[#3b494b]';
  ...
  return (
    <>
      <div className="mb-6 flex flex-col md:flex-row gap-4 justify-between items-center bg-white border border-neutral-200 p-4">
        <div className="relative w-full md:w-96">
          ...
          <input
            ...
            className="w-full bg-[#1a1c20] border border-[#3b494b] pl-10 pr-4 py-2 text-neutral-900 focus:border-[#10b981] focus:outline-none transition-colors font-mono text-sm"
          />
        </div>
        ...
        <div className="w-full md:w-auto flex items-center gap-2">
          ...
          <select
            ...
            className="w-full md:w-auto bg-[#1a1c20] border border-[#3b494b] px-4 py-2 text-neutral-900 focus:border-[#10b981] focus:outline-none transition-colors font-mono text-sm appearance-none"
          >
      ...
      <div className="bg-white border border-neutral-200 overflow-x-auto">
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="border-b border-neutral-200 bg-[#1a1c20]">
          ...
          <tbody>
            {filteredData.length === 0 ? (
              ...
              filteredData.map((app) => (
                <tr key={app.id} className="border-b border-neutral-200 hover:bg-[#1a1c20] transition-colors">
      ...
      {selectedApp && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
          <div className="bg-white border border-neutral-200 w-full max-w-4xl max-h-[90vh] overflow-y-auto shadow-2xl">
            <div className="sticky top-0 bg-[#1a1c20] border-b border-neutral-200 p-4 flex justify-between items-center z-10">
            ...
            <div className="p-6 grid md:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <select
                        ...
                        className="w-full bg-[#1a1c20] border border-[#3b494b] px-3 py-2 text-neutral-900 focus:border-[#10b981] focus:outline-none transition-colors text-sm appearance-none"
                      >
                        <option value="Submitted">Submitted</option>
                        <option value="Under Review">Under Review</option>
                        <option value="Shortlisted">Shortlisted</option>
                      ...
                      <div className="space-y-4 border-t border-neutral-200 pt-4">
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            className="w-full bg-[#1a1c20] border border-[#3b494b] p-3 text-neutral-900 focus:border-[#10b981] focus:outline-none transition-colors text-sm resize-none"
                          />
                        </div>
                      </div>
                    )}
                    ...
                    <button
                      ...
                      disabled={isUpdating}
                      className="w-full flex items-center justify-center gap-2 border border-[#10b981] bg-[#10b981] px-4 py-2 font-mono text-sm font-bold uppercase text-black transition-all hover:bg-transparent hover:text-[#10b981] hover:shadow-[0_0_15px_rgba(0,240,255,0.4)] disabled:opacity-50"
                    >
              ...
              <div className="space-y-6">
                    ...
                    <div className="space-y-3">
                      {timeline.map((event, index) => (
                        <div key={event.id} className="relative pl-6 border-l-2 border-neutral-200">
                          <div className="absolute left-0 top-0 w-4 h-4 -translate-x-1/2 bg-[#10b981] rounded-full"></div>
                          <div className="bg-[#1a1c20] p-3 border border-neutral-200">
                ...
                <div>
                  ...
                  <p className="text-sm bg-[#1a1c20] p-4 border border-neutral-200 whitespace-pre-wrap">{selectedApp.motivation}</p>
                </div>
                
                <div>
                  <h3 className="font-mono text-sm uppercase text-neutral-600 border-b border-neutral-200 pb-2 mb-4">Goals</h3>
                  <p className="text-sm bg-[#1a1c20] p-4 border border-neutral-200 whitespace-pre-wrap">{selectedApp.goals}</p>
                </div>
                
                <div>
                  <h3 className="font-mono text-sm uppercase text-neutral-600 border-b border-neutral-200 pb-2 mb-4">Impact</h3>
                  <p className="text-sm bg-[#1a1c20] p-4 border border-neutral-200 whitespace-pre-wrap">{selectedApp.impact}</p>
                </div>
                
                <div>
                  <h3 className="font-mono text-sm uppercase text-neutral-600 border-b border-neutral-200 pb-2 mb-4">Why Select You</h3>
                  <p className="text-sm bg-[#1a1c20] p-4 border border-neutral-200 whitespace-pre-wrap">{selectedApp.why_you}</p>
                </div>
              </div>
            </div>
          </div>
