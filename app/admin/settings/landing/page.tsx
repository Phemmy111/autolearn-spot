        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-xl font-bold text-brand-text">Landing Page Settings</h1>
                <p className="text-sm text-brand-text/70">Configure hero section and landing page content</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSave} className="space-y-8">
          ...
          <div className="border border-brand-border bg-[var(--card)] brightness-95/50 backdrop-blur-xl rounded-xl p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-lg font-semibold text-brand-text">Hero Content</h2>
            </div>
            <div className="space-y-6">
              <div>
                <label className="block text-sm font-medium text-brand-text/70 mb-2">Headline</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-brand-text/70 mb-2">Subheadline</label>
                <textarea
              ...
              <div>
                <label className="block text-sm font-medium text-brand-text/70 mb-2">Badge Text</label>
                <input
                  type="text"
          ...
          <div className="border border-brand-border bg-[var(--card)] brightness-95/50 backdrop-blur-xl rounded-xl p-6">
            <div className="flex items-center gap-3 mb-6">
              <Layout className="h-5 w-5 text-[#10b981]" />
              <h2 className="text-lg font-semibold text-brand-text">Call-to-Action Buttons</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-medium text-brand-text/70 mb-2">Primary CTA Text</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-brand-text/70 mb-2">Primary CTA Link</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-brand-text/70 mb-2">Secondary CTA Text</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-brand-text/70 mb-2">Secondary CTA Link</label>
                <input
                  type="text"
          ...
          <div className="border border-brand-border bg-[var(--card)] brightness-95/50 backdrop-blur-xl rounded-xl p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-lg font-semibold text-brand-text">Hero Media</h2>
            </div>
            <div className="space-y-6">
              <div>
                <label className="block text-sm font-medium text-brand-text/70 mb-2">Media Type</label>
                <select
              ...
              {settings.mediaType === 'video' && (
                <div className="space-y-4">
                  <div>
                    <label className="block text-sm font-medium text-brand-text/70 mb-2">Video URL</label>
                    <input
                      type="url"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-brand-text/70 mb-2">Or Upload Video</label>
                    <label className="flex items-center gap-3 p-4 bg-[var(--card)] brightness-95 border border-brand-border rounded-lg cursor-pointer hover:border-[#10b981] transition-colors">
                      <Video className="h-5 w-5 text-[#10b981]" />
                      <div className="flex-1">
                        <p className="text-sm text-brand-text">{videoFile ? videoFile.name : 'Choose video file...'}</p>
                        <p className="text-xs text-brand-text/70">MP4, WebM, MOV (max 50MB)</p>
                      </div>
                      <input
                        type="file"
                        accept="video/*"
              ...
              {settings.mediaType === 'image' && (
                <div className="space-y-4">
                  <div>
                    <label className="block text-sm font-medium text-brand-text/70 mb-2">Image URL</label>
                    <input
                      type="url"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-brand-text/70 mb-2">Or Upload Image</label>
                    <label className="flex items-center gap-3 p-4 bg-[var(--card)] brightness-95 border border-brand-border rounded-lg cursor-pointer hover:border-[#10b981] transition-colors">
                      <Image className="h-5 w-5 text-[#10b981]" />
                      <div className="flex-1">
                        <p className="text-sm text-brand-text">{imageFile ? imageFile.name : 'Choose image file...'}</p>
                        <p className="text-xs text-brand-text/70">PNG, JPG, WebP (max 5MB)</p>
                      </div>
                      <input
                        type="file"
                        accept="image/*"
          ...
          <div className="border border-brand-border bg-[var(--card)] brightness-95/50 backdrop-blur-xl rounded-xl p-6">
            <div className="flex items-center gap-3 mb-6">
              <Video className="h-5 w-5 text-[#10b981]" />
              <h2 className="text-lg font-semibold text-brand-text">Preview Video</h2>
            </div>
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-brand-text/70 mb-2">Preview Video URL</label>
                <input
                  type="url"
                  ...
                  placeholder="https://..."
                />
                <p className="text-xs text-brand-text/70 mt-1">This video will play when users click "Watch Preview" on the landing page</p>
              </div>
              <div>
                <label className="block text-sm font-medium text-brand-text/70 mb-2">Or Upload Preview Video</label>
                <label className="flex items-center gap-3 p-4 bg-[var(--card)] brightness-95 border border-brand-border rounded-lg cursor-pointer hover:border-[#10b981] transition-colors">
                  <Video className="h-5 w-5 text-[#10b981]" />
                  <div className="flex-1">
                    <p className="text-sm text-brand-text">{previewVideoFile ? previewVideoFile.name : 'Choose preview video file...'}</p>
                    <p className="text-xs text-brand-text/70">MP4, WebM, MOV (max 50MB)</p>
                  </div>
                  <input
                    type="file"
