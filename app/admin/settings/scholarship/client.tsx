  ...
  if (loading) {
    return (
      <div className="border border-brand-border bg-[var(--card)] brightness-95 rounded-lg p-6">
        <p className="text-brand-text/70">Loading settings...</p>
      </div>
    );
  }
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <input
            ...
            className="w-full bg-brand-bg border border-[#3b494b] px-3 py-2 font-mono text-sm text-brand-text focus:outline-none focus:border-[#10b981]"
            placeholder="5000"
          />
          <p className="text-xs text-brand-text/60 mt-1">Amount scholarship applicants pay as commitment fee</p>
        </div>
        ...
        <div>
          ...
          <input
            ...
            placeholder="8000"
          />
          <p className="text-xs text-brand-text/60 mt-1">Original course value displayed to applicants</p>
        </div>
        ...
        <div>
          ...
          />
          <p className="text-xs text-brand-text/60 mt-1">Payment link sent to accepted scholarship applicants</p>
        </div>
        ...
        <div>
          ...
          <p className="text-xs text-brand-text/60 mt-1">Master toggle to enable/disable scholarship applications</p>
        </div>
        ...
        <div>
          ...
          />
          <p className="text-xs text-brand-text/60 mt-1">WhatsApp group for all scholarship applicants</p>
        </div>
        ...
        <div>
          ...
          <input
            ...
            placeholder="https://chat.whatsapp.com/..."
          />
          <p className="text-xs text-brand-text/60 mt-1">WhatsApp group for paid scholarship students</p>
        </div>
        ...
        <div className="pt-4 border-t border-brand-border">
          <button
            ...
            disabled={saving}
            className="flex items-center gap-2 bg-brand-bg text-[#00363a] px-6 py-2 font-mono text-sm font-semibold uppercase tracking-wider hover:bg-brand-bg/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
