      ...
      <div className="space-y-6">
        ...
        <div className="pt-4 border-t border-neutral-200">
          <button
            ...
            disabled={saving}
            className="flex items-center gap-2 bg-gray-50 text-[#00363a] px-6 py-2 font-mono text-sm font-semibold uppercase tracking-wider hover:bg-gray-50/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
