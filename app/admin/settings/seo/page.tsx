        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-xl font-bold text-neutral-900">SEO & Metadata Settings</h1>
                <p className="text-sm text-neutral-600">Configure website SEO and social sharing metadata</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSave} className="space-y-8">
          ...
          <div className="border border-neutral-200 bg-gray-100/50 backdrop-blur-xl rounded-xl p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-lg font-semibold text-neutral-900">Basic SEO</h2>
            </div>
            <div className="space-y-6">
              <div>
                <label className="block text-sm font-medium text-neutral-600 mb-2">Site Title</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-neutral-600 mb-2">Meta Description</label>
                <textarea
          ...
          <div className="border border-neutral-200 bg-gray-100/50 backdrop-blur-xl rounded-xl p-6">
            <div className="flex items-center gap-3 mb-6">
              <Globe className="h-5 w-5 text-[#10b981]" />
              <h2 className="text-lg font-semibold text-neutral-900">Open Graph (Social Sharing)</h2>
            </div>
            <div className="space-y-6">
              <div>
                <label className="block text-sm font-medium text-neutral-600 mb-2">OG Title</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-neutral-600 mb-2">OG Description</label>
                <textarea
              ...
              <div>
                <label className="block text-sm font-medium text-neutral-600 mb-2">OG Image URL</label>
                <input
                  type="url"
          ...
          <div className="border border-neutral-200 bg-gray-100/50 backdrop-blur-xl rounded-xl p-6">
            <div className="flex items-center gap-3 mb-6">
              <Globe className="h-5 w-5 text-[#10b981]" />
              <h2 className="text-lg font-semibold text-neutral-900">Twitter Card</h2>
            </div>
            <div>
              <label className="block text-sm font-medium text-neutral-600 mb-2">Card Type</label>
              <select
