        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-xl font-bold text-neutral-900">General & Brand Settings</h1>
                <p className="text-sm text-neutral-600">Configure website name, colors, and contact information</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSave} className="space-y-8">
          ...
          <div className="border border-neutral-200 bg-white/50 backdrop-blur-xl rounded-xl p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-medium text-neutral-600 mb-2">Site Name</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-neutral-600 mb-2">Tagline</label>
                <input
                  type="text"
          ...
          <div className="border border-neutral-200 bg-white/50 backdrop-blur-xl rounded-xl p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                <label className="block text-sm font-medium text-neutral-600 mb-2">Primary Color</label>
              ...
              <div>
                <label className="block text-sm font-medium text-neutral-600 mb-2">Secondary Color</label>
                <div className="flex gap-2">
                  <input
                    type="color"
          ...
          <div className="border border-neutral-200 bg-white/50 backdrop-blur-xl rounded-xl p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-medium text-neutral-600 mb-2">Support Email</label>
                <input
                  type="email"
              ...
              <div>
                <label className="block text-sm font-medium text-neutral-600 mb-2">Support Phone</label>
                <input
                  type="tel"
              ...
              <div>
                <label className="block text-sm font-medium text-neutral-600 mb-2">Support WhatsApp</label>
                <input
                  type="tel"
              ...
              <div>
                <label className="block text-sm font-medium text-neutral-600 mb-2">WhatsApp Direct Link</label>
                <input
                  type="url"
          ...
          <div className="border border-neutral-200 bg-white/50 backdrop-blur-xl rounded-xl p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-medium text-neutral-600 mb-2">WhatsApp Community</label>
                <input
                  type="url"
              ...
              <div>
                <label className="block text-sm font-medium text-neutral-600 mb-2">Instagram</label>
                <input
                  type="url"
              ...
              <div>
                <label className="block text-sm font-medium text-neutral-600 mb-2">TikTok</label>
                <input
                  type="url"
              ...
              <div>
                <label className="block text-sm font-medium text-neutral-600 mb-2">YouTube</label>
                <input
                  type="url"
              ...
              <div>
                <label className="block text-sm font-medium text-neutral-600 mb-2">Facebook</label>
                <input
                  type="url"
              ...
              <div>
                <label className="block text-sm font-medium text-neutral-600 mb-2">Twitter/X</label>
                <input
                  type="url"
              ...
              <div>
                <label className="block text-sm font-medium text-neutral-600 mb-2">LinkedIn</label>
                <input
                  type="url"
