    ...
    <div className="min-h-screen bg-[#c0c4c9] text-neutral-900">
      ...
      <main className="pt-32 pb-20">
        ...
        <section className="px-6 lg:px-8 max-w-7xl mx-auto flex flex-col items-center text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#10b981]/10 border border-[#10b981]/20 text-[#10b981] mb-8 animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link 
              ...
              className="px-8 py-4 rounded-full bg-[#10b981] text-black font-bold text-lg hover:bg-white transition-all transform hover:scale-105 flex items-center justify-center gap-2"
            >
