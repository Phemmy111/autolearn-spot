    ...
    <div className="min-h-screen bg-[var(--background)] text-[var(--foreground)]">
      ...
      <main className="pt-32 pb-20">
        ...
        <section className="px-6 lg:px-8 max-w-7xl mx-auto flex flex-col items-center text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[var(--primary)]/10 border border-[var(--primary)]/20 text-[var(--primary)] mb-8 animate-fade-in">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-6 bg-gradient-to-r from-white via-white to-white/50 bg-clip-text text-transparent">
            Share knowledge.<br />
            <span className="text-[var(--primary)]">Earn rewards.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link 
              ...
              className="px-8 py-4 rounded-full bg-[var(--primary)] text-black font-bold text-lg hover:bg-white transition-all transform hover:scale-105 flex items-center justify-center gap-2"
            >
        ...
        <section className="px-6 lg:px-8 max-w-7xl mx-auto mt-32">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-xl relative overflow-hidden group hover:border-[var(--primary)]/50 transition-colors">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[var(--primary)]/10 blur-3xl rounded-full -mr-16 -mt-16 transition-all group-hover:bg-[var(--primary)]/20" />
              <DollarSign className="h-10 w-10 text-[var(--primary)] mb-6" />
        ...
        {/* How it works */}
        <section className="px-6 lg:px-8 max-w-7xl mx-auto mt-32">
          <div className="p-12 rounded-3xl bg-gradient-to-br from-white/5 to-[var(--primary)]/5 border border-white/10">
            <h2 className="text-3xl font-bold mb-12 text-center">How it works</h2>
            
            <div className="grid md:grid-cols-4 gap-8">
              <div className="text-center relative">
                <div className="w-16 h-16 rounded-full bg-[var(--primary)]/20 text-[var(--primary)] flex items-center justify-center text-2xl font-bold mx-auto mb-6">1</div>
                <h4 className="font-bold mb-2">Apply</h4>
                <p className="text-sm text-[#b9cacb]">Submit your simple application to join</p>
                <div className="hidden md:block absolute top-8 left-[60%] w-full h-[2px] bg-gradient-to-r from-[var(--primary)]/50 to-transparent" />
              </div>
              
              <div className="text-center relative">
                <div className="w-16 h-16 rounded-full bg-[var(--primary)]/20 text-[var(--primary)] flex items-center justify-center text-2xl font-bold mx-auto mb-6">2</div>
              ...
              <div className="text-center relative">
                <div className="w-16 h-16 rounded-full bg-[var(--primary)]/20 text-[var(--primary)] flex items-center justify-center text-2xl font-bold mx-auto mb-6">3</div>
              ...
              <div className="text-center">
                <div className="w-16 h-16 rounded-full bg-[var(--primary)]/20 text-[var(--primary)] flex items-center justify-center text-2xl font-bold mx-auto mb-6">4</div>
