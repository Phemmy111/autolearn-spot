        ...
        <section className="px-6 lg:px-8 max-w-7xl mx-auto flex flex-col items-center text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Link 
              ...
              className="px-8 py-4 rounded-full bg-gray-100/5 border border-white/10 font-bold text-lg hover:bg-gray-100/10 transition-all flex items-center justify-center"
            >
              Partner Login
            </Link>
          </div>
