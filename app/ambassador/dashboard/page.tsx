      ...
      <main className="max-w-7xl mx-auto px-4 md:px-6 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-[var(--card)] border border-[var(--border)] rounded-2xl p-6">
            ...
            <p className="text-sm text-[var(--muted-foreground)] mb-1">Total Clicks</p>
          ...
          <div className="bg-[var(--card)] border border-[var(--border)] rounded-2xl p-6">
            ...
            <p className="text-sm text-[var(--muted-foreground)] mb-1">Registrations</p>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
                  ...
                  <table className="w-full text-left">
                    ...
                    <tbody className="text-sm">
                      {data.commissions.map((comm: any) => (
                        <tr key={comm.id} className="border-b border-[var(--border)] last:border-0">
          ...
          <div className="bg-[var(--card)] border border-[var(--border)] rounded-2xl p-6 flex flex-col h-fit">
            ...
            <form onSubmit={handleWithdraw} className="mt-auto space-y-4">
              <div>
                <label className="text-sm text-[var(--muted-foreground)] mb-1.5 block">Amount to withdraw</label>
