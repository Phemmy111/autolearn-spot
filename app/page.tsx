...
function CurriculumSection() {
  return (
    <section id="curriculum" className="py-8 sm:py-12 lg:py-16 bg-[#0c0e12]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
...
function FeaturesSection() {
  return (
    <section id="tools" className="py-8 sm:py-12 lg:py-16 bg-[#050505]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-6 sm:mb-10 lg:mb-14">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-[#e2e2e8] mb-3 sm:mb-4">
            What You'll Learn
...
function FAQSection() {
  ...
  return (
    <section id="faq" className="py-8 sm:py-12 lg:py-16 bg-[#050505]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
...
function Footer() {
  return (
    <footer className="border-t border-[#1f2229] bg-[#0c0e12] py-8 sm:py-12 lg:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
