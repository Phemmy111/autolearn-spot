        ...
        <div className="grid md:grid-cols-2 gap-4 sm:gap-6 lg:gap-12">
          <div className={`border border-neutral-200 bg-gray-100]/80 backdrop-blur-xl rounded-2xl p-4 sm:p-6 lg:p-8 xl:p-10 reveal-on-scroll ${isVisible ? 'is-visible' : ''}`}>
            ...
            {cohort && !cohortLoading && (
              <div className="mb-6 sm:mb-8 border border-neutral-200 bg-gray-100]/60 rounded-xl p-4 sm:p-5">
            ...
            <div className="space-y-3 sm:space-y-4">
              {[
                ...
                return (
                  <div
                    key={item.title}
                    className="border border-neutral-200 bg-gray-100]/80 backdrop-blur-xl rounded-xl p-4 sm:p-5 lg:p-6 card-enhanced"
                    style={{ transitionDelay: `${0.3 + index * 0.1}s` }}
                  >
                    <div className="flex items-start gap-3 sm:gap-4">
                      <div className="flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 border border-[#10b981]/60 bg-gray-100]/10 rounded-lg flex items-center justify-center">
