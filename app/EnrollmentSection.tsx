...
import { CheckCircle, Star, Rocket, Users, GraduationCap, MessageCircle } from 'lucide-react'
            ...
            <div className="space-y-3 sm:space-y-4">
              {[
                ...
                return (
                  <div
                    key={item.title}
                    className="border border-[#1f2229] bg-[#0c0e12]/80 backdrop-blur-xl rounded-xl p-4 sm:p-5 lg:p-6"
                  >
