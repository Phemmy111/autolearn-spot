      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="p-6 bg-[var(--card)] brightness-95 border border-brand-border rounded-lg">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-sm font-medium text-brand-text/70">Enrolled Courses</span>
          </div>
        ...
        <div className="p-6 bg-[var(--card)] brightness-95 border border-brand-border rounded-lg">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-sm font-medium text-brand-text/70">Completed</span>
          </div>
          <p className="text-3xl font-bold text-brand-text">0</p>
        </div>
        ...
        <div className="p-6 bg-[var(--card)] brightness-95 border border-brand-border rounded-lg">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-sm font-medium text-brand-text/70">Certificates</span>
          </div>
          <p className="text-3xl font-bold text-brand-text">0</p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            <div className="flex items-center gap-3 mb-2">
              ...
              <h3 className="font-semibold text-brand-text">My Learning</h3>
            </div>
          ...
          >
            <div className="flex items-center gap-3 mb-2">
              <BookOpen className="w-6 h-6 text-sky-600" />
              <h3 className="font-semibold text-brand-text">Browse Courses</h3>
            </div>
            <p className="text-sm text-brand-text/70 mb-3">
