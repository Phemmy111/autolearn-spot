      ...
      <div className="max-w-[1280px] mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 lg:gap-6">
          {PARTNER_TESTIMONIALS.map((testimonial, index) => (
            <div key={index} className="border border-border bg-card rounded-2xl p-4 sm:p-5 lg:p-6">
              <div className="flex items-start gap-3 sm:gap-4 mb-3 sm:mb-4">
                <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-full border-2 border-primary/30 overflow-hidden flex-shrink-0">
                  <Image
      ...
      <div className="max-w-3xl mx-auto px-6 lg:px-8">
        ...
        <div className="space-y-3 sm:space-y-4">
          {faqs.map((faq, index) => (
            <div
              key={index}
              className="border border-border bg-surface-hover rounded-xl overflow-hidden"
            >
              <button
              ...
              {openIndex === index && (
                <div className="px-4 sm:px-5 lg:px-6 pb-3 sm:pb-4 text-sm text-muted-foreground">
                  {faq.answer}
                </div>
              )}
            </div>
