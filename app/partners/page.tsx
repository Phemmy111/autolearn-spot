...
const PARTNER_TYPES = [
  {
    ...
    commission: "₦1,500",
    description: "Automatically activated after purchasing the ₦8,000 course",
...
const ACTIVITY_FEED = [
  "Deborah from Lagos just enrolled for ₦8,000",
      ...
      <div className="relative max-w-[1280px] mx-auto px-6 lg:px-8 pt-24 md:pt-20 lg:pt-16 pb-12">
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="space-y-6 lg:space-y-8 flex flex-col justify-center">
            ...
            <div className="inline-flex items-center gap-2 border border-primary/60 bg-primary/10 px-4 py-2 sm:px-5 sm:py-2.5">
              <DollarSign className="h-5 w-5 text-primary" />
              <span className="font-mono text-sm font-semibold uppercase tracking-[0.14em] text-primary">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              ...
              <Link
                ...
                className="flex items-center justify-center gap-2 border border-primary bg-transparent px-5 py-3 sm:px-6 sm:py-3 lg:px-8 lg:py-4 font-mono text-[11px] font-semibold uppercase tracking-[0.1em] text-primary transition duration-150 hover:bg-primary/10 w-full sm:w-auto"
              >
                Partner Dashboard
              </Link>
            </div>
          ...
          <div className="relative order-2 md:order-2 mt-8 md:mt-0">
            <div className="border border-border bg-card rounded-2xl p-4 sm:p-5 lg:p-6 shadow-primary">
              <div className="absolute inset-0 bg-primary/5 rounded-2xl blur-xl" />
              <div className="relative z-10">
                <div className="flex items-center justify-between mb-3 sm:mb-4">
                  <span className="font-mono text-[10px] uppercase tracking-[0.14em] text-muted-foreground">Partner Dashboard Preview</span>
        ...
        <div className="flex flex-wrap justify-center gap-4 sm:gap-6 lg:gap-8">
          {TRUST_PARTNERS.map((partner, index) => (
            <div key={index} className="flex flex-col items-center gap-3">
              <div className="w-14 h-14 sm:w-16 sm:h-16 lg:w-20 lg:h-20 rounded-full border-2 border-primary/30 overflow-hidden">
                <Image
                  src={partner.image}
                  alt={partner.name}
                  width={80}
      ...
      <div className="max-w-[1280px] mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4 lg:gap-6">
          {PARTNER_TYPES.map((type, index) => (
            <div key={index} className="border border-border bg-card rounded-2xl p-4 sm:p-5 lg:p-6 hover:border-primary/50 transition-colors">
              <div className="flex items-center justify-between mb-3 sm:mb-4">
                <span className="font-mono text-[10px] uppercase tracking-[0.14em] text-muted-foreground">Commission</span>
      ...
      <div className="max-w-[1280px] mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 lg:gap-6">
          {PARTNER_TESTIMONIALS.map((testimonial, index) => (
            <div key={index} className="border border-[var(--border-default)] bg-[var(--card)] rounded-2xl p-4 sm:p-5 lg:p-6 shadow-sm hover:border-[var(--primary)] hover:shadow-lg transition-all">
              <div className="flex items-start gap-3 sm:gap-4 mb-3 sm:mb-4">
                <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-full border-2 border-[var(--border-default)] overflow-hidden flex-shrink-0">
                  <Image
                ...
                <div>
                  <h3 className="font-bold text-sm sm:text-base text-[var(--text-primary)]">{testimonial.name}</h3>
                  <p className="text-xs sm:text-sm text-[var(--text-muted)]">{testimonial.school}</p>
              ...
              <p className="text-sm text-[var(--text-body)] italic">"{testimonial.review}"</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="max-w-[1280px] mx-auto px-6 lg:px-8">
        ...
        <div className="border border-border bg-card rounded-2xl overflow-hidden">
          {LEADERBOARD.map((item, index) => (
            <div key={index} className="flex items-center justify-between p-3 sm:p-4 lg:p-5 border-b border-border last:border-b-0">
  ...
  return (
    <section className="py-4 sm:py-6 lg:py-8 bg-[var(--background)]">
      <div className="max-w-3xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-3 sm:mb-4 lg:mb-6">
          <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-[var(--text-primary)] mb-2 sm:mb-3 lg:mb-4">Frequently Asked Questions</h2>
          <p className="text-sm sm:text-base text-[var(--text-muted)]">Got questions? We've got answers</p>
        </div>
        ...
        <div className="space-y-3 sm:space-y-4">
          {faqs.map((faq, index) => (
            ...
            >
              ...
              {openIndex === index && (
                <div className="px-4 sm:px-5 lg:px-6 pb-3 sm:pb-4 text-sm text-[var(--text-body)]">
                  {faq.answer}
                </div>
              )}
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 mb-4 sm:mb-6 lg:mb-8">
          <div className="md:col-span-2">
            ...
            <div className="flex gap-3 flex-wrap">
              <a href={socialLinks.facebook.url} target="_blank" rel="noopener noreferrer" className="text-sm text-muted-foreground hover:text-primary transition-colors">
                Facebook
              </a>
              <a href={socialLinks.linkedin.url} target="_blank" rel="noopener noreferrer" className="text-sm text-muted-foreground hover:text-primary transition-colors">
                LinkedIn
              </a>
              <a href={socialLinks.instagram.url} target="_blank" rel="noopener noreferrer" className="text-sm text-muted-foreground hover:text-primary transition-colors">
                Instagram
              </a>
              <a href={socialLinks.tiktok.url} target="_blank" rel="noopener noreferrer" className="text-sm text-muted-foreground hover:text-primary transition-colors">
                TikTok
              </a>
              <a href={socialLinks.youtube.url} target="_blank" rel="noopener noreferrer" className="text-sm text-muted-foreground hover:text-primary transition-colors">
                YouTube
              </a>
              <a href={socialLinks.x.url} target="_blank" rel="noopener noreferrer" className="text-sm text-muted-foreground hover:text-primary transition-colors">
                X
              </a>
              <a href={socialLinks.whatsapp.url} target="_blank" rel="noopener noreferrer" className="text-sm text-muted-foreground hover:text-primary transition-colors">
                WhatsApp
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/partners/apply" className="text-sm text-muted-foreground hover:text-primary transition-colors">
                  Apply Now
                </Link>
              </li>
              <li>
                <Link href="/partners/dashboard" className="text-sm text-muted-foreground hover:text-primary transition-colors">
                  Partner Dashboard
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href={socialLinks.whatsapp.url} className="text-sm text-muted-foreground hover:text-primary transition-colors">
                  WhatsApp Support
                </a>
              </li>
              <li>
