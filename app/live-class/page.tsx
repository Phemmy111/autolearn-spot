        ...
        <>
          {settings.date && settings.time && settings.date !== '' && settings.time !== '' ? (
            <div className="text-center mb-8">
              ...
              <button
                className="mt-6 px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-brand-text rounded-lg shadow hover:scale-105 transform transition"
                onClick={handleJoin}
                disabled={!isLive}
              >
          ...
          {settings.status === 'replay' && settings.recordingUrl && settings.replayEnabled === 'true' && (
            <div className="text-center mt-8">
              ...
              <a
                ...
                className="inline-block px-6 py-3 bg-gradient-to-r from-green-600 to-teal-600 text-brand-text rounded-lg shadow hover:scale-105 transform transition"
              >
                Watch Recording
              </a>
            </div>
