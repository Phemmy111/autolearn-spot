...
export default function StudentPartnerPage() {
  ...
  if (!isLoaded || status === 'loading') {
    return (
      <div className="flex min-h-screen items-center justify-center bg-[#c0c4c9]">
  ...
  if (status === 'not_partner') {
    return (
      <div className="min-h-screen bg-[#c0c4c9] py-12 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="bg-[#c0c4c9] border border-neutral-200 rounded-3xl p-8 md:p-12 text-center relative overflow-hidden">
            <div className="absolute top-0 right-0 w-64 h-64 bg-[#10b981]/10 blur-3xl rounded-full" />
            ...
            <Link 
              href="/enroll"
              className="inline-flex items-center gap-2 px-8 py-4 bg-[#10b981] text-black font-bold rounded-xl hover:bg-white transition-colors relative z-10"
            >
              Complete Enrollment
  ...
  return (
    <div className="min-h-screen bg-[#c0c4c9] py-8 px-4">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        {/* Referral Link Card */}
        <div className="bg-gradient-to-r from-[#00f0ff]/10 via-purple-500/10 to-transparent border border-[#10b981]/20 rounded-2xl p-6 md:p-8">
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-2 w-full lg:w-auto">
              ...
              <button 
                ...
                className="bg-[#10b981] text-black px-4 py-3 rounded-lg font-bold hover:bg-white transition-colors flex-shrink-0 flex items-center gap-2"
              >
        ...
        <div className="bg-[#c0c4c9] border border-neutral-200 rounded-2xl p-6">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-3">
              <div className="bg-[#c0c4c9] border border-neutral-200 rounded-lg px-6 py-3 font-mono text-2xl font-bold text-[#10b981] tracking-wider">
                {data?.referralCode}
              </div>
              <button 
          ...
          {data?.marketingResources && data.marketingResources.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {data.marketingResources.map((resource: any, index: number) => (
                <div key={index} className="bg-[#c0c4c9] border border-neutral-200 rounded-xl p-4 hover:border-[#10b981]/50 transition-colors">
        ...
        <div className="bg-[#c0c4c9] border border-neutral-200 rounded-2xl p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <button
              ...
              className="bg-[#10b981] text-black px-4 py-2 rounded-lg font-bold hover:bg-white transition-colors"
            >
          ...
          <div className="bg-[#c0c4c9] border border-neutral-200 rounded-xl p-6 mb-4">
            ...
            <form onSubmit={handleWithdraw} className="flex items-center gap-4">
              ...
              <button
                ...
                className="bg-[#10b981] text-black px-6 py-3 rounded-lg font-bold hover:bg-white transition-colors disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap"
              >
      ...
      {showBankModal && (
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
          <div className="bg-[#c0c4c9] border border-neutral-200 rounded-2xl p-6 w-full max-w-md">
            <div className="flex items-center justify-between mb-6">
            ...
            <form onSubmit={handleSaveBankDetails} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#c0c4c9] border border-neutral-200 rounded-lg px-4 py-3 text-neutral-900 focus:border-[#10b981] focus:outline-none"
              ...
              <div className="flex gap-3 pt-4">
                ...
                <button
                  ...
                  className="flex-1 bg-[#10b981] text-black px-4 py-3 rounded-lg font-bold hover:bg-white transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
      ...
      {showMaterialModal && selectedMaterial && (
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
          <div className="bg-[#c0c4c9] border border-neutral-200 rounded-2xl p-6 w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex gap-3 pt-4 border-t border-neutral-200">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-[#10b981] text-black rounded-lg font-medium hover:bg-white transition-colors"
              >
