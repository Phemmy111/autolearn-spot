...
export default function NotificationSettingsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#c0c4c9] text-[#e2e8e2] p-4 sm:p-8">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-6">
          <div className="border border-[#3b494b] bg-[#c0c4c9] p-6 rounded-xl">
            ...
            <div className="flex items-center justify-between py-3 border-b border-[#3b494b]/50">
              ...
              <button 
                ...
                className={`w-12 h-6 rounded-full transition-colors relative ${preferences.email_notifications ? 'bg-[#10b981]' : 'bg-[#3b494b]'}`}
              >
          ...
          <div className="border border-[#3b494b] bg-[#c0c4c9] p-6 rounded-xl">
            ...
            <div className="space-y-4">
              <label className="flex items-start gap-4 cursor-pointer group">
                <div className={`w-5 h-5 border mt-0.5 flex items-center justify-center transition-colors ${preferences.announcement_notifications ? 'border-[#10b981] bg-[#10b981]/20 text-[#10b981]' : 'border-[#3b494b] bg-[#c0c4c9] text-transparent'}`}>
              ...
              <label className="flex items-start gap-4 cursor-pointer group">
                <div className={`w-5 h-5 border mt-0.5 flex items-center justify-center transition-colors ${preferences.assignment_updates ? 'border-[#10b981] bg-[#10b981]/20 text-[#10b981]' : 'border-[#3b494b] bg-[#c0c4c9] text-transparent'}`}>
                  <svg className="w-3 h-3 fill-current" viewBox="0 0 20 20"><path d="M0 11l2-2 5 5L18 3l2 2L7 18z"/></svg>
                </div>
                <input
                  type="checkbox"
              ...
              <label className="flex items-start gap-4 cursor-pointer group">
                <div className={`w-5 h-5 border mt-0.5 flex items-center justify-center transition-colors ${preferences.quiz_notifications ? 'border-[#10b981] bg-[#10b981]/20 text-[#10b981]' : 'border-[#3b494b] bg-[#c0c4c9] text-transparent'}`}>
                  <svg className="w-3 h-3 fill-current" viewBox="0 0 20 20"><path d="M0 11l2-2 5 5L18 3l2 2L7 18z"/></svg>
                </div>
                <input
                  type="checkbox"
              ...
              <label className="flex items-start gap-4 cursor-pointer group">
                <div className={`w-5 h-5 border mt-0.5 flex items-center justify-center transition-colors ${preferences.live_class_notifications ? 'border-[#10b981] bg-[#10b981]/20 text-[#10b981]' : 'border-[#3b494b] bg-[#c0c4c9] text-transparent'}`}>
                  <svg className="w-3 h-3 fill-current" viewBox="0 0 20 20"><path d="M0 11l2-2 5 5L18 3l2 2L7 18z"/></svg>
                </div>
                <input
                  type="checkbox"
          ...
          <div className="flex items-center gap-4">
            <button
              onClick={handleSave}
              disabled={saving}
              className="flex items-center gap-2 bg-[#10b981] px-6 py-3 font-mono text-sm font-bold uppercase text-black transition hover:bg-white disabled:opacity-50"
            >
              <Save className="h-4 w-4" />
              {saving ? 'Saving...' : 'Save Settings'}
            </button>
            {message && (
              <span className={`font-mono text-sm ${message.includes('success') ? 'text-[#10b981]' : 'text-[#ff6b6b]'}`}>
                {message}
              </span>
            )}
          </div>
