...
export default function ScholarshipStatusPage() {
  ...
  return (
    <main className="min-h-screen bg-[#c0c4c9] text-[#e2e2e8] flex flex-col">
      <Navigation />
      <div className="pt-24 flex-1 flex items-center justify-center p-4">
        ...
        <div className="w-full max-w-md">
          ...
          {step === 'request' && (
            <div className="bg-[#c0c4c9] border border-neutral-200 p-8 relative overflow-hidden">
              ...
              <form onSubmit={handleRequestOTP} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[#1a1c20] border border-[#3b494b] p-4 text-neutral-900 focus:border-[#10b981] focus:outline-none transition-colors text-center"
                  />
                </div>
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full flex items-center justify-center gap-2 bg-[#10b981] text-black font-mono font-bold uppercase p-4 hover:bg-transparent hover:text-[#10b981] hover:shadow-[0_0_15px_rgba(0,240,255,0.4)] border border-[#10b981] transition-all disabled:opacity-50"
                >
          ...
          {step === 'verify' && (
            <div className="bg-[#c0c4c9] border border-neutral-200 p-8 relative overflow-hidden animate-fade-in-up">
              <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#00f0ff] to-[#00363a]" />
              <div className="text-center mb-8">
                <div className="w-12 h-12 bg-[#10b981]/10 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <form onSubmit={handleVerifyOTP} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[#1a1c20] border border-[#3b494b] p-4 text-neutral-900 text-2xl tracking-[0.5em] focus:border-[#10b981] focus:outline-none transition-colors text-center font-mono"
                  />
                </div>
                <button
                  type="submit"
                ...
                <button
                  ...
                  className="w-full text-sm text-[#b9cacb] hover:text-[#10b981] mt-4 transition-colors"
                >
          ...
          {step === 'result' && result && (
            <div className="bg-[#c0c4c9] border border-neutral-200 p-8 text-center relative overflow-hidden animate-fade-in-up">
              <div className={`absolute top-0 left-0 w-full h-1 ${
                result.status === 'Accepted' ? 'bg-green-400' :
                result.status === 'Under Review' ? 'bg-[#10b981]' :
              ...
              <div className="bg-[#1a1c20] border border-neutral-200 p-6 mb-8">
                  ...
                  {result.payment_status === 'Waiting' && (
                    <div className="space-y-3">
                      <a
                        ...
                        className="block w-full flex items-center justify-center gap-2 bg-[#10b981] text-black font-mono font-bold uppercase p-4 hover:bg-transparent hover:text-[#10b981] hover:shadow-[0_0_15px_rgba(0,240,255,0.4)] border border-[#10b981] transition-all"
                      >
                      ...
                      <button
                        ...
                        disabled={isLoading}
                        className="block w-full text-xs text-[#b9cacb] hover:text-[#10b981] border border-[#3b494b] py-2 transition-colors disabled:opacity-50"
                      >
              ...
              <button
                ...
                className="w-full text-sm text-[#b9cacb] hover:text-neutral-900 mt-8 border border-[#3b494b] py-3 transition-colors"
              >
