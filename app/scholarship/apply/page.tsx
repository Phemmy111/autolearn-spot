...
export default function ScholarshipApplyPage() {
  ...
  if (step === 5 && successData) {
    return (
      <main className="min-h-screen bg-[#c0c4c9] text-[#e2e2e8] flex flex-col items-center justify-center p-4">
        <div className="max-w-md w-full bg-[#c0c4c9] border border-neutral-200 p-8 text-center relative overflow-hidden">
          ...
          <Link
            ...
            className="w-full flex items-center justify-center gap-2 border border-[#10b981] bg-[#10b981]/10 px-6 py-3 font-mono text-sm font-bold uppercase text-[#10b981] transition-all hover:bg-[#10b981] hover:text-black hover:shadow-[0_0_15px_rgba(0,240,255,0.4)]"
          >
            Check Status Page
          </Link>
        </div>
  ...
  return (
    <main className="min-h-screen bg-[#c0c4c9] text-[#e2e2e8] pb-24">
      <Navigation />
      <div className="pt-24">
        ...
        <div className="flex gap-2 mb-12">
          {[1, 2, 3, 4].map(i => (
            <div key={i} className={`h-1 flex-1 ${i <= step ? 'bg-[#10b981]' : 'bg-[#1f2229]'}`} />
          ))}
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          {step === 1 && (
            <div className="space-y-6 animate-fade-in-up">
              <h2 className="font-heading text-xl font-bold border-b border-neutral-200 pb-4 mb-6 text-[#10b981]">1. Personal Information</h2>
          ...
          {step === 2 && (
            <div className="space-y-6 animate-fade-in-up">
              <h2 className="font-heading text-xl font-bold border-b border-neutral-200 pb-4 mb-6 text-[#10b981]">2. Technology Background</h2>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4 pt-4 border-t border-neutral-200">
                  <label className="flex items-center gap-3 p-4 border border-neutral-200 bg-[#c0c4c9] hover:border-[#10b981]/50 cursor-pointer transition-colors">
          ...
          {step === 3 && (
            <div className="space-y-6 animate-fade-in-up">
              <h2 className="font-heading text-xl font-bold border-b border-neutral-200 pb-4 mb-6 text-[#10b981]">3. Motivation & Goals</h2>
          ...
          {step === 4 && (
            <div className="space-y-6 animate-fade-in-up">
              ...
              <div className="space-y-4">
                ...
                <label className="flex items-start gap-3 p-4 border border-[#10b981]/30 bg-[#c0c4c9] mt-6 cursor-pointer">
          ...
          <div className="flex justify-between items-center pt-8 border-t border-neutral-200 mt-8">
            ...
            {step < 4 ? (
              <button
                type="button"
                onClick={nextStep}
                className="flex items-center gap-2 px-6 py-3 border border-[#10b981] bg-[#10b981]/10 font-mono text-sm font-bold uppercase text-[#10b981] hover:bg-[#10b981] hover:text-black transition-colors shadow-[0_0_15px_rgba(0,240,255,0.2)]"
              >
              ...
              <button
                ...
                className="flex items-center gap-2 px-8 py-3 border border-[#10b981] bg-[#10b981] font-mono text-sm font-bold uppercase text-black hover:bg-transparent hover:text-[#10b981] transition-colors shadow-[0_0_20px_rgba(0,240,255,0.4)] disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isSubmitting ? (
